...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:variable name="doctype">Регион/Город</xsl:variable>
								...
								<form action="Provider" name="frm" method="post" id="frm" enctype="application/x-www-form-urlencoded">
									<div display="block" id="property">
										...
										<table width="100%" border="0">
											<tr>
												<td width="30%" class="fc">Регион/Город :</td>
										        <td>
								                	<input type="text" name="name" value="{document/fields/name}" size="30" class="rof" style="background:#fff; padding:3px 3px 3px 5px; width:300px">
											...
											<tr>
												<td class="fc">Страна :</td>
												<td>
													<input type="text" value="{document/fields/country}" name="country" size="20" class="rof" style="background:#fff; padding:3px 3px 3px 5px; width:300px">
								                    	<xsl:if test="document/@editmode != 'edit'">
															<xsl:attribute name="readonly">readonly</xsl:attribute>
															<xsl:attribute name="style">background:none; padding:3px 3px 3px 5px; width:300px</xsl:attribute>
														</xsl:if>
