...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:variable name="doctype">Тип документа</xsl:variable>
				       				...
				       				<form action="Provider" name="frm" method="post" id="frm" enctype="application/x-www-form-urlencoded">
										<div display="block"  id="property">
											...
											<table width="80%" border="0">
												<tr>
													<td width="30%" class="fc">Тип документа :</td>
									           		<td>
						                                 <input type="text" name="name" value="{document/fields/name}" size="75" class="rof" style="background:#fff; padding:3px 3px 3px 5px; width:500px">
