...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:variable name="doctype">Номенклатура дел</xsl:variable>
					...
					<div class="formwrapper">
						...
						<span style="float:left">
							...
							<a class="gray button form">
								...
								<font class="font">Сохранить и закрыть</font>
							</a>
						</span>
									...
									<div display="block"  id="property">
										...
										<table width="80%" border="0">
											<tr>
									            ...
									            <td>
					                                 <input type="text" name="name" value="{document/fields/name}" size="100" class="rof" style="background:#fff; padding:3px 3px 3px 5px; width:600px">
									       ...
									       <tr>
												<td class="fc">Код :</td>
												<td>
					                           		<input type="text" name="kod" value="{document/fields/kod}" size="10" class="rof" style="background:#fff; padding:3px 3px 3px 5px; width:300px">
					                           			<xsl:if test="document/@editmode != 'edit'">
															<xsl:attribute name="readonly">readonly</xsl:attribute>
									       ...
									       <tr>
												<td class="fc">Ранг :</td>
												<td>
					                          		<input type="text" name="rank" value="{document/fields/rank}" size="10" class="rof" style="background:#fff; padding:3px 3px 3px 5px; width:300px">
					                          			<xsl:if test="document/@editmode != 'edit'">
															<xsl:attribute name="readonly">readonly</xsl:attribute>
															<xsl:attribute name="style">background:none; padding:3px 3px 3px 5px; width:300px</xsl:attribute>
														</xsl:if>
									       ...
									       <tr>
												<td class="fc">Номенклатура :</td>
												<td>
					                          		<input type="text" name="ndelo" value="{document/fields/ndelo}" size="10" class="rof" style="background:#fff; padding:3px 3px 3px 5px; width:300px">
					                          			<xsl:if test="document/@editmode != 'edit'">
															<xsl:attribute name="readonly">readonly</xsl:attribute>
															<xsl:attribute name="style">background:none; padding:3px 3px 3px 5px; width:300px</xsl:attribute>
														</xsl:if>
