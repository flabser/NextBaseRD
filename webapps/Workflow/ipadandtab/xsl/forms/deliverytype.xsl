...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:variable name="doctype">Вид доставки</xsl:variable>
							...
							<form action="Provider" name="frm" method="post" id="frm" enctype="application/x-www-form-urlencoded">
								<div display="block"  id="property">
									...
									<table width="100%" border="0">
										<tr>
											<td class="fc">Тип доставки :</td>
			            					<td>
				                                <input type="text" name="name" value="{document/fields/name}" size="55" class="rof" style="background:#fff; padding:3px 3px 3px 5px; width:300px">
