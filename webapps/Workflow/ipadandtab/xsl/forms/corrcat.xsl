...
<xsl:stylesheet version="1.0"
	...
	<xsl:variable name="doctype">Категория корреспондентов</xsl:variable>
	...
	<xsl:template match="/request">
		<html>
			<head>
				<title>Категория корреспондентов</title>
								...
								<form action="Provider" name="frm" method="post" id="frm" enctype="application/x-www-form-urlencoded">
									<div display="block" id="property">
										...
										<table width="80%" border="0">
											<tr>
												<td width="30%" class="fc">Категория корреспондентов :</td>
												<td>
													<input type="text" name="name" value="{document/fields/name}" size="55" class="rof" style="background:#fff; padding:3px 3px 3px 5px; width:600px">
											...
											<tr>
												<td class="fc">Код :</td>
												<td>
													<input type="text" name="code" value="{document/fields/code}" size="15" class="rof" style="background:#fff; padding:3px 3px 3px 5px; width:300px">
														<xsl:if test="document/@editmode != 'edit'">
															<xsl:attribute name="readonly">readonly</xsl:attribute>
