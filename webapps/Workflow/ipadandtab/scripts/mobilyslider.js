					...
					var slider = {
						...
						slide : {
							left : function(sign) {
								...
								item.eq(step).css({
								'-webkit-transform': 'translate3d('+ sign+'100% , 0px, 0px)',
						...
						bullets : {
							...
							update : function() {
								setTimeout(function(){bullet.removeClass("active").eq(step).addClass(
								"active")},500);
							}
						},
						arrows : {
