...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
							...
							<div id="tableheader">
								<table class="viewtable" id="viewtable" width="100%">
									<tr class="th">
										...
										<td style="text-align:center;height:30px; width:25%;" class="thcell">
											<xsl:call-template name="sortingcell">
	...
	<xsl:template match="//query/entry">
		...
		<tr title="{@viewtext}" class="{@docid}" id="{@docid}{@doctype}">
			...
			<td style="padding-left:25px;border:1px solid #ccc; min-width:150px;">
			...
			<td style="text-align:left; border:1px solid #ccc; width:25%; padding-left:25px; word-wrap:break-word">
				<a  href="{@url}" title="{viewcontent/viewtext}" class="doclink">
					<xsl:if test="@isread = 0">
						<xsl:attribute name="style">font-weight:bold;</xsl:attribute>
					</xsl:if> 
