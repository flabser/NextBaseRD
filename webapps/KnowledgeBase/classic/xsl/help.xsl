		...
		<html style="overflow:auto">
			...
			<body style="font-family: Verdana, arial, helvetica, sans-serif; padding:0px; margin:0px">
				<div  style="position:absolute;  top:0px; left:0px; width:100%; height:70px; border-bottom:1px solid rgba(190,213,224,0.89); background:url('classic/img/blue_background.jpg');">
					...
					<span style="float:left; margin:15px 0 0 25px">
						<xsl:if test="/request/@lang = 'KAZ'"> 
							<font style="font-size:1.6em; color:#404040; padding-left: 10px ">Projects</font> 
							<font style="font-size:1em; color:#595959;  padding-left: 10px;">Жобаларды басқару</font>
						</xsl:if>
						<xsl:if test="/request/@lang = 'RUS'"> 
							<font style="font-size:1.6em; color:#404040; padding-left: 10px ">Projects</font> 
							<font style="font-size:1em; color:#595959;  padding-left: 10px;">Управление проектами</font>
						</xsl:if>		
							<xsl:if test="/request/@lang = 'ENG'"> 
							<font style="font-size:1.6em; color:#404040; padding-left: 10px ">Projects</font> 
							<font style="font-size:1em; color:#595959;  padding-left: 10px;">Projects management</font>
						</xsl:if>	
					</span>
